...
import {
  EditSafetyService
} from '../../core/edit-safety/edit-safety.service';
...
export class TasksComponent {
  ...
  private readonly firebaseTasksService =
      inject(FirebaseTasksService);


  readonly tasks$ =
      this.firebaseTasksService.getTasks();
  ...
  readonly timelineOptions: {
...

    {
      ...
      label: 'Acum',
      description:
          'Taskuri curente sau fără un termen mai apropiat de nuntă'
    },

    {
      ...
      description:
          'În jurul datei de 5 august 2026'
    },

    {
      value: 'three-weeks',
      label: '3 săptămâni înainte',
      description:
          'În jurul datei de 15 august 2026'
    },

    {
      value: 'one-week',
      label: '1 săptămână înainte',
      description:
          'În jurul datei de 29 august 2026'
    },
...

    {
      ...
      label: 'După nuntă',
      description:
          'Plăți, returnări și închideri după eveniment'
    }
  ...
  statusFilter:
      WeddingTaskStatus | 'all' =
      'all';


  /*
   * Doar o secțiune de timeline este deschisă
   * în același timp.
   */
  expandedStage:
      WeddingTimelineStage | null =
      null;
  ...
  /* ==========================================
     IMPORT SPRINT CHECKLIST
  ========================================== */

  async importSprint3Checklist():
      Promise<void> {
